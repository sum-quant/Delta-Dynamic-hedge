...
int main() {
    ...
    ofstream hedgetest("hedgetesting.csv");
    ...
    std::cout << "Bench Marking Implied Volatilty calculation Method"<<endl;
    ...
    std::cout << "******************************************************" << endl;
    std::cout << "Starting Part 3rd of the Assignment: " << endl;
    std::cout << "\nEnter the Type of Option Call-C Put-P Capital Case" << endl;
    ...
    if (typeOfOption == "C" || typeOfOption == "P") {
        ...
        if (optionPrice.size() != 0) {
            ...
            for (int i = 1; i < optionPrice.size(); i++)
            {
                ...
                profitLoss.push_back( optionPrice[0]- optionPrice[i]);
            }
            // creating my result file
            ofstream result("finalResultTable.csv");
            ...
            std::cout << "Processed Part3 of the Assignment. Excel is in results folder under name finalTable.csv" << endl;
            std::cout << "*************************END*****************************" << endl;
        }
